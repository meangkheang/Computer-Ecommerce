        ...
        <div class="grid grid-cols-2 w-2/3 gap-2">
            ...
            <div class="flex flex-col items-start p-3 gap-2">
                ...
                <div class="flex flex-col gap-2">
                    <h1 class="">Size: <span class="font-bold">A</span></h1>
                    <div class="flex gap-4">
                        <button class="border p-1 hover:border-red-500">Size A</button>
                        <button class="border p-1 hover:border-red-500">Size B</button>
                        <button class="border p-1 hover:border-red-500">Size C</button>
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    <h1 class="">Color: <span class="font-bold">A</span></h1>
                    <div class="flex gap-4">
                        <button class="border p-1 hover:border-red-500">Color A</button>
                        <button class="border p-1 hover:border-red-500">Color B</button>
                        <button class="border p-1 hover:border-red-500">Color C</button>
                    </div>
                </div>
