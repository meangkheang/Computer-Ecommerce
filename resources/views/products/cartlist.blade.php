        ...
        <div class="">
            ...
            <div class="flex items-start justify-between">
                <div class="flex gap-8 w-[50%]">
                    <img src="https://images.unsplash.com/photo-1576566588028-4147f3842f27?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" alt="" class="w-[30%] md:w-[25%] rounded-sm object-cover">
                    <div>
                ...
                <div>
                    ...
                    <button class="px-4 py-2 bg-red-400 rounded-sm mt-4">Remove</button>
                </div>
            ...
            <div class="flex items-start justify-between">
                <div class="flex gap-8 w-[50%]">
                    <img src="https://images.unsplash.com/photo-1551739440-5dd934d3a94a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" alt="" class="w-[30%] md:w-[25%] rounded-sm object-cover">
                    <div>
                        <div class="flex flex-col items-start justify-between h-full">
                            <div>
                                <p class="text-lg ">Normad Tumbler</p>   
