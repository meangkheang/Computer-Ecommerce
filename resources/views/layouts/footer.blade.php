<footer class="flex-col flex mt-12 text-sm relative ">
    <div class="md:flex bg-red-600 justify-around p-4">
        <div class="flex flex-col md:w-1/3 gap-4">
            <a href="/" class="py-3">
                <span class=" text-6xl  text-black">C<span class="text-red-200">E</span>CM</span>
                {{-- <img src="" alt="" class="w-6 rounded"> --}}
            </a>
            <div class="text-wrap">
                <p>Lorem ipsum dolor sit amet, consec
                    tetur adipisicing elit, sed do eiusmod tempor incididuntut
                    consec tetur adipisicing
                    elit,Lorem ipsum dolor sit amet.</p>
            </div>
            <span class="text-3xl text-white">Follow us</span>
            <div class="flex gap-4">

                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="24"
        ...
        <div class="flex col">
            <div class="footer-widget">
                <div class="md:mt-0 mt-4">
                    <h3 class="text-white text-3xl">Useful Links</h3>
                </div>
    ...
    <div class="bg-red-700 flex justify-between p-6 items-center md:flex-row flex-col">
        <span class="text-sm text-white sm:text-center">© 2022 <a href="#" class="hover:underline">CECM</a>.
            All
            Rights
            Reserved.
        </span>
        <ul class="flex items-center text-sm text-white xs:pt-0">
            <li>
