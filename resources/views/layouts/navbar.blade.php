<nav class="shadow-2xl flex items-center justify-around md:text-lg  md:justify-around w-full xs:justify-between xs:border  xs:p-4 ">
    <a href="/">
      <span class="sm:pl-4 text-md font first-letter:text-3xl first-letter:text-green-400">CECM</span>
      {{-- <img src="" alt="" class="w-6 rounded"> --}}
    </a>

      <div class="flex transition ease-in-out duration-500 font-md list-none xs:hidden">
          <li class="p-4 hover:bg-gray-200 hover:text-green-300"><a href="">Home</a></li>
