<nav
    class="shadow-2xl flex items-center justify-around md:text-lg  md:justify-around w-full xs:justify-between xs:border  xs:p-4 ">
    <a href="/">
        <span class="sm:pl-4 text-md">C<span class="text-red-600">E</span>CM</span>
    ...
    <div class="flex transition ease-in-out duration-500 font-md list-none xs:hidden">
        ...
        <li class="p-4  hover:text-white hover:bg-red-600"><a href="">Sales</a></li>
