...
<div class="container mx-auto px-4 sm:px-8 mt-16 ">
    ...
    <form action="{{ route("admin.products.remove",$product->id) }}"  method="post">
        @csrf
        <div class="p-8 bg-white shadow flex justify-center gap-4 items-center">
            <h1>Are you want to delete this product ?</h1>
            <a href="/admin/products" class="px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 text-white text-sm ">Cancel</a>
