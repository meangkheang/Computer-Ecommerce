...
@section('content')
    <div class="mx-auto w-2/3 mt-4 h-[100vh]">
        ...
        <form action="/admin" method="post" class="mt-8 w-1/2 mx-auto flex flex-col gap-3">
            ...
            <input class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2" id="file_input"
                type="file">
            <input type="file" class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2"
                type="text" placeholder="thumnail privew 1" name="product_side[]">
            <input type="file" class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2"
                type="text" placeholder="thumnail preview 2" name="product_side[]">
            <input type="file" class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2"
                type="text" placeholder="thumnail preview 3" name="product_side[]">
            <input class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2" type="text"
                placeholder="Product description" name="description">
            <input class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2" type="text"
                placeholder="Product price" name="price">
            <input class="w-full text-sm rounded px-3 py-2 outline-none  border-blue-400 border-2" type="text"
                placeholder="Product discount" name="discount">
