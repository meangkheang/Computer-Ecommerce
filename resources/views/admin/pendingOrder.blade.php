...
@section('content')
    <div class="w-2/3 mx-auto mt-8 h-screen">
        <div class="header px-4 py-2 w-full flex justify-between">
            ...
            <a href="/admin/orders" class="rounded px-4 py-2 bg-red-600 text-white">History</a>
        </div>
        <div class="content">
                ...
                <div class="px-4 py-4 border w-full mt-2">
                    <div class="flex justify-between px-2">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.accept_pending', $item->orders[0]->order_id ) }}" class="rounded px-4 py-2 bg-green-700 hover:bg-green-800 text-white">Done</a>
                        </div>
                    </div>
                    ...
                    <div id="content" class="hidden px-4 mt-2 border-2 ">
                        ...
                        @forelse($item->orders as $key => $order)

                            <div class="py-2 flex justify-between items-center text-sm">
                                <div class="flex gap-6 w-3/4">

                                    <img src="{{ asset('images/products/' .$order->product->img) }}" alt=""
