...
<body>
    ...
    <div class="w-full relative ">
        ...
        <div
            class="absolute top-20 text-black xs:left-2 xs:translate-x-5 xs:font-thin sm:left-16 md:left-44 lg:left-80">
            ...
            <a href="products">
                <button class="px-8 py-3 bg-black rounded-xl text-white shadow hover:text-red-600">Shop
                    Now</button>
            </a>
        </div>
    </div>
    ...
    <div class="w-full text-center my-12 mb-12">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-1 sm:mx-6 md:mx-20 gap-8 xs:mx-4 xs:gap-2 md:grid-cols-2 lg:mx-52">
            ...
            <div class="grid grid-cols-2 gap-8 xs:gap-2">
                ...
                <div class="col-span-2 ">
                    <img src="https://images.unsplash.com/photo-1589578228447-e1a4e481c6c8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80"
                        alt="" class="rounded">
                </div>

                <div class="">
                    <img src="https://images.unsplash.com/photo-1580236176063-bea7f16aec30?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=672&q=80"
                        alt="" class="rounded h-full">
                </div>

                <div class="">
                    <img src="https://images.unsplash.com/photo-1607677686474-ad91fc94f5ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=680&q=80"
                        alt="" class="rounded h-full">
                </div>
            </div>
    ...
    <div class="w-full mb-12 mt-32">
        <div class="text-center mx-auto w-1/2 xs:w-full xs:px-10 mb-10 ">
            <h1 class="uppercase text-4xl pb-2">Sales</h1>
            <p class="text-left mt-4 text-lg font-thin tracking-tighter">Lorem ipsum dolor sit amet, consectetur
        ...
        <div class="grid grid-cols-4 sm:grid-cols-2 gap-8 flex-wrap xs:grid-cols-1 xs:gap-3 mx-52 xs:mx-4">
            <div class="xs:mb-6 cursor-pointer">
                <a href="/products/">
                    <img src="https://images.unsplash.com/photo-1494621930069-4fd4b2e24a11?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=715&q=80"
                        alt=""
                        class="rounded h-96 object-cover w-full hover:scale-105 transition-all duration-200 delay-75 ">
                </a>
        ...
        <div class="flex gap-8 justify-center flex-wrap">
            <div class="p-4 shadow-lg w-[16rem]">
                <img src="https://i.pinimg.com/736x/50/9e/c0/509ec0cb3a7f1d47d67afc81a8751f70.jpg" alt=""
                    class="rounded-full w-24 mb-4 mx-auto">
                <div>
                    <h1>Thomas</h1>
                    <span class="text-xs font-thin text-gray-300 bg-red-600 rounded px-2 py-1">React Dev</span>
                    <br>

                    <p class="mt-6 text-sm font-thin">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius,
            ...
            <div class="p-4 shadow-lg w-[16rem]">
                ...
                <div>
                    <h1>Thomas</h1>
                    <span class="text-xs font-thin text-gray-300 bg-red-600 rounded px-2 py-1">Rail Dev</span>
                    <br>
            ...
            <div class="p-4 shadow-lg w-[16rem]">
                ...
                <div>
                    <h1>Thomas</h1>
                    <span class="text-xs font-thin text-gray-300 bg-red-600 rounded px-2 py-1">Laravel Dev</span>
                    <br>
            ...
            <div class="p-4 shadow-lg w-[16rem]">
                ...
                <div>
                    <h1>Thomas</h1>
                    <span class="text-xs font-thin text-gray-300 bg-red-600 rounded px-2 py-1">C# Dev</span>
                    <br>
