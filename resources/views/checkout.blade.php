    ...
    <div class="h-[50vh] w-1/2 mx-auto">
        ...
        <form action="/checkout" class="flex flex-wrap gap-3 w-full p-5" id="form" method="post">
            ...
            <label class="relative w-full flex flex-col">
                ...
                <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" type="text"
                    name="card_number" placeholder="0000 0000 0000" />
            ...
            <label class="relative w-full flex flex-col">
                ...
                <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" type="text"
                    name="card_number" placeholder="Name" />
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="absolute bottom-0 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <label class="relative flex-1 flex flex-col">
                ...
                <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" type="text"
                    name="expire_date" placeholder="MM/YY" />
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="absolute bottom-0 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="w-full text-center mt-8">
            ...
            <a onclick="document.getElementById('form').submit()"
                class="cursor-pointer inline-block bg-blue-600 text-white  py-2 rounded px-4">Procced Payment</a>
